...
cp -rp ~/workspace/$JOB_NAME/target/$package_name ~/rpmbuild/SOURCES/$package_name-$version/;
cp -rp ~/workspace/$JOB_NAME/src/main/resources/scripts/*.sh ~/rpmbuild/SOURCES/$package_name-$version/
