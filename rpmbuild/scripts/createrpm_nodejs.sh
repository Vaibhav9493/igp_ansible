...
cp -rp ~/workspace/$JOB_NAME/* ~/rpmbuild/SOURCES/$package_name-$version/;

rm -rf ~/rpmbuild/SOURCES/$package_name-$version/$package_name/.git;
rm -rf ~/rpmbuild/SOURCES/$package_name-$version/$package_name/.gitignore;
